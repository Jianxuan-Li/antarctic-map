      ...
      >
              ...
              return (
                <div key={item.key}>
                  <input
                    ...
                    checked={currentBaseLayerValue == item.value}
                  />{" "}
                  <label htmlFor={"radio_" + item.value}>{item.name}</label>
                  {currentBaseLayerValue == item.value && baseLayerLoading && (
                    <ProgressBar progress={baseLayerProgress} />
                  )}
                </div>
              );
            })}
              ...
              return (
                <div key={item.key}>
                  <input
                    ...
                    name="layer"
                    value={item.value}
                    id={"layer_" + item.value}
                    onChange={(e) => this.handleLayerChange(e)}
                    checked={currentLayerValue == item.value}
                  />{" "}
                  <label htmlFor={"layer_" + item.value}>{item.name}</label>
                </div>
              );
            })}
          <button
            onClick={this.handleClearLayer}
            style={{ display: currentLayerValue ? "block" : "none" }}
          >
            Clear
          </button>
        </div>
        ...
        <div>
          ...
          <input
            ...
            checked={currentDataset == "seaice"}
          />{" "}
          <label htmlFor="dataset_seaice">Sea ice</label>
        </div>

        <div className={styles.badges}>
          <a href="https://github.com/FreeYeti/antarctic-map">
            <img
              alt="GitHub Repo stars"
              src="https://img.shields.io/github/stars/freeyeti/antarctic-map?label=github"
            />
          </a>
          <a href="https://github.com/FreeYeti/antarctic-map/actions">
            <img
              alt="GitHub Workflow Status"
              src="https://img.shields.io/github/workflow/status/freeyeti/antarctic-map/release"
            />
          </a>
          <a href="https://gitlab.com/FreeYeti/antarctic-map/">
            <img
              alt="pipeline status"
              src="https://gitlab.com/FreeYeti/antarctic-map/badges/master/coverage.svg"
            />
          </a>
        </div>
      </div>
